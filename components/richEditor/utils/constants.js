...
export const COLORS = [
  "#000000", "#FFFFFF", "#888888", "#AAAAAA", "#EEEEEE", "#880000", "#CC0000", "#FF0000", "#FFCCCC", "#FF8800", "#FFCC00", "#FFFF00", "#CCFF00",
  "#88FF00", "#008800", "#00CC00", "#00CC88", "#00CCCC", "#CCEEFF", "#00CCFF", "#0088FF", "#0000FF", "#8800FF", "#CC00CC", "#CC0088"
];
export const FONTS = ["Arial", "Arial Black", "Comic Sans MS", "Courier New", "Helvetica Neue", "Helvetica", "Impact", "Lucida Grande", "Tahoma", "Times New Roman", "Verdana"];
...
export const availableBlockTypes = [
  ...
  {type: "horizontal-rule", display: {name: "h-rule"}, tag: "hr"},
  ...
  {type: "unordered-list-item", display: {name: "bullet list"}},
  {type: "ordered-list-item", display: {name: "number list"}},
  {type: "blockquote", display: {name: "blockquote", style: {fontFamily: "'Hoefler Text', Georgia, serif", fontStyle: "italic"}}, tag: "blockquote"},
...
const dropdownControls = {
  ...
  fontFamily: {
    activeOption: font => availableFonts.find(f => f.display.name === font) || {display: {name: "theme default", style: {fontStyle: "italic"}}},
    controlWidth: 130,
    dropdownWidth: 155,
  ...
  fontSize: {
    activeOption: fontSize => availableFontSizes.find(size => size.display.name === +fontSize) || {display: {name: "--"}},
    controlWidth: 40,
    dropdownWidth: 65,
    list: [...availableFontSizes, {type: "fontSize.unset", display: {name: "reset", style: {fontStyle: "italic"}}}],
    method: "listDropdown"
  },
  insertImage: {
